...
<div class="container" style="padding-top:75px;background-color:#F1F1F8">
      <div class="col-xs-8  col-xs-offset-2">
          <h3 class="text-center">Submit your question to ZeusBB support center</h3>
        <div class="row">
        ...
        <div class="row">
         ...
         <div class="row">
            <div class="form-group col-xs-12" >
              <label>Reason</label>       
    <div class="dropdown">
  <button class="form-control dropdown-toggle text-left" type="button" data-toggle="dropdown">Select
  <span class="caret"></span></button>
  <ul class="dropdown-menu">

    <li><a href="#">I lost my Password </a></li>
    <li><a href="#">How delete my account</a></li>
    <li><a href="#">I can't answer any question</a></li>
  </ul>
</div>
          </div>
        </div>
        ...
        <div class="row">
            <div class="form-group col-xs-12" >
              ...
              <textarea name="" class="form-control" id="" value="" rows="10"></textarea>
            </div>
        </div>

        <div class="row">
            <div class="form-group col-xs-12" >
              <button type="submit" class="btn btn-primary" id="" value="">SUBMIT</button>
            </div>
        </div>
      </div>
    </form>
