      ...
      ';
		...
		<div class="container" style="padding-top:75px;background-color:#F1F1F8">
			...
			<div class="row">
               ...
               <?php  AllMemebers(); ?> 
              	<!--Start of USER Info-->
           <!--  	<div class="col-md-3 members thumbnail">
                	<div class="row">
                		<center><img src="avatar/def.jpg" class="img-responsive img-circle"></center>
                	</div> 
                	<div class="row">
                		<div><h3 class="text-center">User name</h3></div>
                	</div>	
                	
                	<div class="row">
                		<center><button type="button" class="btn btn-info">View</button></center>
                	</div>  
              	</div> 
